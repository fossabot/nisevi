...
ActiveRecord::Schema.define(version: 2016_10_22_125257) do
  ...
  create_table "categories", id: :serial, force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["topic"], name: "index_categories_on_topic", unique: true
  end
  ...
  create_table "links", id: :serial, force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["social_media"], name: "index_links_on_social_media", unique: true
  end
  ...
  create_table "portfolio_skills", id: :serial, force: :cascade do |t|
  ...
  create_table "skills", id: :serial, force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["superpower"], name: "index_skills_on_superpower", unique: true
  end
